...
import org.firstinspires.ftc.teamcode.library.BasicMoveOperation;
...
public class PrototypeV1AutoRedRight extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        BasicMoveOperation.moveForward(0.5F);
        BasicMoveOperation.turnRight(0.175F);
        BasicMoveOperation.moveForward(0.65F);
    }
}
